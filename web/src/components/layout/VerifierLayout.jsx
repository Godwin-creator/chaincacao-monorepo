    ...
    <div className="min-h-screen flex bg-cream">
      <aside className="w-64 bg-chain-bg flex flex-col shrink-0">
        <div className="p-6 border-b border-white/10">
          ...
          <p className="text-chain-cyan-light text-xs mt-1">Espace Vérificateur UE</p>
        </div>

        <nav className="flex-1 p-4 space-y-1">
          <NavLink to="/verifier" end className={navLinkClass}>Tableau de bord</NavLink>
          <NavLink to="/verifier/lot-inspection" className={navLinkClass}>Inspection de lot</NavLink>
        </nav>
